...
class Config:
    ...
    OPENROUTER_FALLBACK_API_KEY_1 = os.getenv("OPENROUTER_FALLBACK_API_KEY_1")
    OPENROUTER_FALLBACK_API_KEY_2 = os.getenv("OPENROUTER_FALLBACK_API_KEY_2")
    OPENROUTER_FALLBACK_API_KEY_3 = os.getenv("OPENROUTER_FALLBACK_API_KEY_3")
