...
def generate_video(image_path: str, audio_path: str, output_path: str, duration: int = 10):
    """
    Uses FFmpeg to combine a static image and an audio file into an MP4 video (Instagram Reel).
    """
